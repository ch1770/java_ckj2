...
public class StudentEx {
 public static void main(String[] args) {
	//student 객체생성 
	 ...
	 int[] score = {10,20,30,40,50}; //확생1의성적 배열 
	 ...
	 System.out.println("학생1 -Java공부하기");
	 student.study("Java");
	 ...
	 System.out.println("학생2 -Python공부하기");
	 ...
	 System.out.println("학생2 -최종점수 :" +student.getAverage(score2));
	 System.out.println();
}
